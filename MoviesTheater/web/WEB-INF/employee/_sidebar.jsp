...
<aside class="cgv-sidebar" style="background: linear-gradient(180deg, #1e293b 0%, #0f172a 100%); border-right: 1px solid rgba(59,130,246,0.2);">

    <div class="cgv-sidebar-top" style="border-bottom: 1px solid rgba(59,130,246,0.15);">
        <img class="cgv-logo" src="${pageContext.request.contextPath}/Image/Icon/cgvlogo.png" alt="CGV Cinema">
        <div style="font-size:9px;font-weight:700;letter-spacing:2px;text-transform:uppercase;color:rgba(96,165,250,0.6);margin-top:4px;">Employee Panel</div>
    </div>

    <nav class="cgv-nav">
        <a href="${pageContext.request.contextPath}/employee"
           class="cgv-nav-link ${activeNav eq 'dashboard' ? 'active' : ''}"
           style="${activeNav eq 'dashboard' ? 'background:rgba(59,130,246,0.15);color:#fff;' : ''}">
        ...
        <div style="font-size:9px;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;color:rgba(96,165,250,0.4);padding:16px 16px 6px;">Menu</div>
        ...
        <a href="${pageContext.request.contextPath}/manager/checkin"
    ...
    <div class="cgv-sidebar-bottom" style="border-top: 1px solid rgba(59,130,246,0.15);">
        <a href="${pageContext.request.contextPath}/" class="cgv-nav-link" style="color:rgba(148,163,184,0.6);">
            <svg class="cgv-nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
