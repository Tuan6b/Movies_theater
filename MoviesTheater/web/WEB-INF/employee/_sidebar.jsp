...
<aside class="cgv-sidebar">
    ...
    <nav class="cgv-nav">
        ...
        <a href="${pageContext.request.contextPath}/employee/movies"
        ...
        <a href="${pageContext.request.contextPath}/FoodController"
           class="cgv-nav-link ${activeNav eq 'food' ? 'active' : ''}">
            <svg class="cgv-nav-icon" viewBox="0 0 24 24" fill="none"
                 stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
