...
<head>
    ...
    <title>Quản lý Thể loại Phim - CGV Admin</title>
...
<body class="cgv-body">
    ...
    <%-- ==========================================
         SIDEBAR NAVIGATION
         Sử dụng class: cgv-sidebar, cgv-nav, cgv-nav-link
         ========================================== --%>
    ...
    <main class="cgv-main">
        ...
        <div class="cgv-page">
            ...
            <%-- COLUMN 1: DANH SÁCH THỂ LOẠI (LEFT) --%>
            ...
            <%-- COLUMN 2: FORM THÊM MỚI & THỐNG KÊ (RIGHT - ASIDE) --%>
