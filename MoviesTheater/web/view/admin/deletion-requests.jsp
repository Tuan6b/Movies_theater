...
<% request.setAttribute("activeNav", "deletion"); %>
<!DOCTYPE html>
<html lang="vi">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Yêu cầu xóa tài khoản — Admin</title>
...
<div class="cgv-main">
    <header class="cgv-header">
        <h1 class="cgv-header-title">Yêu cầu xóa tài khoản</h1>
                ...
                <tbody>
                    ...
                    <tr style="border-bottom:1px solid var(--cgv-border);">
                        ...
                        <td style="padding:10px;">
                            <form method="post" action="${pageContext.request.contextPath}/deletion-request" style="display:flex;gap:8px;">
                                <input type="hidden" name="action" value="review">
                                <input type="hidden" name="id" value="${r.requestId}">
                                <button type="submit" name="status" value="Approved" style="background:#16a34a;color:#fff;border:none;padding:6px 14px;border-radius:6px;cursor:pointer;" onclick="return confirm('Duyệt yêu cầu xóa tài khoản này? Tài khoản sẽ bị khóa.')">Duyệt</button>
